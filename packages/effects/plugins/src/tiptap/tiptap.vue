...
const tiptapContentClass = cn(
  ...
  'color-text max-h-(--vben-tiptap-max-height) min-h-(--vben-tiptap-min-height) overflow-auto leading-7 outline-none',
);
          ...
          >
            ...
            >
              ...
              <button
                ...
                class="h-8 w-full rounded-xl border border-border bg-secondary text-muted-foreground transition-colors hover:bg-background-accented hover:color-text"
                type="button"
