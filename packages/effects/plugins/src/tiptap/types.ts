...
export interface ImageUploadOptions {
  ...
  maxSize?: number;
  /** Upload failure callback; uses alert when not provided */
  onUploadError?: (error: unknown) => void;
  /** Upload handler returning image URL; optional onProgress reports upload progress */
  upload: (
    file: File,
...
export interface VbenTiptapExtensionOptions {
  imageUpload?: ImageUploadOptions;
  /** Internal: track blob URLs for cleanup on component destroy */
