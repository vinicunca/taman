...
import { formatDate, formatDateTime, isFunction } from '@taman/utils';
...
function extendProxyOption(
  ...
  const wrapperFn = async (
    ...
    const data = await configFn(
      ...
      {
        /**
         * When toolbarConfig.refresh is enabled,
         * clicking refresh passes a PointerEvent here with incorrect params
         */
