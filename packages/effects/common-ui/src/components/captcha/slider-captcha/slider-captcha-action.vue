...
<template>
  <div
    ...
    :style="style"
    class="absolute top-0 left-0 flex-center h-full cursor-move bg-background px-3.5 shadow-md dark:bg-background-accented"
    name="captcha-action"
  >
    <Slot :is-passing="isPassing" class="size-4 color-text/60">
      <slot name="icon">
