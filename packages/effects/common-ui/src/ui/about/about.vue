...
<template>
  <Page :title="title">
    <template #description>
      <p class="mt-3 text-sm/6 color-text">
    ...
    <div class="card-box p-5">
      <div>
        <h5 class="text-lg color-text">基本信息</h5>
      </div>
      <div class="mt-4">
        <dl class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          <template v-for="item in vbenDescriptionItems" :key="item.title">
            <div class="border-t border-border px-4 py-6 sm:col-span-1 sm:px-0">
              <dt class="text-sm/6 font-medium color-text">
                {{ item.title }}
              </dt>
              <dd class="mt-1 text-sm/6 color-text sm:mt-2">
    ...
    <div class="card-box mt-6 p-5">
      <div>
        <h5 class="text-lg color-text">生产环境依赖</h5>
      </div>
      <div class="mt-4">
        <dl class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          <template v-for="item in dependenciesItems" :key="item.title">
            <div class="border-t border-border px-4 py-3 sm:col-span-1 sm:px-0">
              ...
              <dd class="mt-1 text-sm color-text/80 sm:mt-2">
                <VbenRenderContent :content="item.content" />
              </dd>
            </div>
          </template>
    ...
    <div class="card-box mt-6 p-5">
      <div>
        <h5 class="text-lg color-text">开发环境依赖</h5>
      </div>
      <div class="mt-4">
        <dl class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
