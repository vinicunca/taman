...
import type { CustomPreferencesRecord } from '@taman/preferences';
import type {
...
const appPreferencesButtonPosition = defineModel<TamanPreferencesButtonPositionType>(
...
const themeBuiltinType = defineModel<TamanBuiltinThemeType>('themeBuiltinType');
const themeMode = defineModel<TamanThemeModeType>('themeMode');
...
const TamanNavigationStyleType = defineModel<TamanNavigationStyleType>(
  'TamanNavigationStyleType',
);
...
const tabs = computed((): Array<SegmentedItem> => {
  const items: Array<SegmentedItem> = [
    {
