          ...
          <DropdownMenuItem
            :class="
              menu.value === modelValue
                ? 'bg-background-accented text-accent-foreground'
                : ''
            "
            class="color-text/80 data-[state=checked]:bg-background-accented data-[state=checked]:text-accent-foreground mb-1 cursor-pointer"
