...
## Corpus Check
- 83 files · ~6,633 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 290 nodes · 352 edges · 15 communities
...
### Community 14 - "taman-loading.vue"
Cohesion: 0.29
Nodes (6): iconProps, props, renderSpinner, showSpinner, TamanLoadingIcon, TamanLoadingIconProps

## Knowledge Gaps
- **153 isolated node(s):** `name`, `type`, `version`, `exports`, `main` (+148 more)
