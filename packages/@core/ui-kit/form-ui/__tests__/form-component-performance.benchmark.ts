...
const [ValidationForm, validationFormApi] = useTamanForm<Record<string, string>>(
  {
...
const dependencySchema: Array<FormSchema> = [
  {
    component: TestInput,
...
const [DependencyForm, dependencyFormApi] = useTamanForm<Record<string, string>>(
  {
