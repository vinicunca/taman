...
export const prose = {
  ...
  h1: {
    slots: {
      base: 'text-4xl color-text-highlighted font-bold mb-8 scroll-mt-[calc(45px+var(--taman-header-height))] lg:scroll-mt-$ui-header-height',
      link: 'inline-flex items-center gap-2',
    },
  },
  h2: {
    slots: {
      base: 'relative text-2xl color-text-highlighted font-bold mt-12 mb-6 scroll-mt-[calc(48px+45px+var(--taman-header-height))] lg:scroll-mt-[calc(48px+var(--taman-header-height))] [&>a]:focus-visible:outline-primary [&>a>code]:border-dashed hover:[&>a>code]:border-primary hover:[&>a>code]:color-primary [&>a>code]:text-xl/7 [&>a>code]:font-bold transition-colors [&>a>code]:transition-colors',
  ...
  h4: {
    slots: {
      base: 'text-lg color-text-highlighted font-bold mt-6 mb-2 scroll-mt-[calc(24px+45px+var(--taman-header-height))] lg:scroll-mt-[calc(24px+var(--taman-header-height))] [&>a]:focus-visible:outline-primary',
      link: '',
    },
  },
  hr: {
  ...
  prompt: {
    slots: {
      ...
      content: 'min-w-0',
      description: 'text-sm/6 color-text font-500',
  ...
  th: {
    base: 'py-3 px-4 font-600 text-sm border-e border-b first:border-s border-t border-border-muted',
    variants: {
      align: {
        left: 'text-left',
        center: 'text-center',
