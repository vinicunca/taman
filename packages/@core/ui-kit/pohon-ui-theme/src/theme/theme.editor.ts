...
export const editor = {
  slots: {
    ...
    base: [
      ...
      // Inline code
      '[&_code]:px-1.5 [&_code]:py-0.5 [&_code]:text-sm [&_code]:font-mono [&_code]:font-500 [&_code]:rounded-md [&_code]:inline-block [&_code]:border [&_code]:border-border-muted [&_code]:color-text-highlighted [&_code]:bg-background-muted',
      // Lists
      '[&_:is(ul,ol)]:ps-6',
