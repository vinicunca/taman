...
export const pricingPlan = {
  slots: {
    ...
    title: 'color-text-highlighted truncate text-2xl sm:text-3xl text-pretty font-semibold',
    description: 'color-text-muted text-base text-pretty mt-2',
    priceWrapper: 'flex items-center gap-1',
    price: 'color-text-highlighted text-3xl sm:text-4xl font-semibold',
    ...
    badge: '',
    button: '',
    tagline: 'text-base font-semibold color-text',
