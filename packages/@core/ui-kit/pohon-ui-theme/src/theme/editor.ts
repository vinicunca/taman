...
export const editor = {
  slots: {
    ...
    base: [
      ...
      '[&_p]:leading-7',
      // Links
      '[&_a]:color-primary [&_a]:border-b [&_a]:border-transparent [&_a]:hover:border-primary [&_a]:font-medium',
      '[&_a]:transition-colors',
      // Code inside links
      '[&_a>code]:border-dashed [&_a:hover>code]:border-primary [&_a:hover>code]:color-primary',
      '[&_a>code]:transition-colors',
      // Mentions
      '[&_.mention]:color-primary [&_.mention]:font-medium',
      ...
      // Code blocks
      '[&_pre]:text-sm/6 [&_pre]:border [&_pre]:border-border-muted [&_pre]:bg-background-muted [&_pre]:rounded-md [&_pre]:px-4 [&_pre]:py-3 [&_pre]:whitespace-pre-wrap [&_pre]:break-words [&_pre]:overflow-x-auto',
      ...
      // Inline code
      '[&_code]:px-1.5 [&_code]:py-0.5 [&_code]:text-sm [&_code]:font-mono [&_code]:font-medium [&_code]:rounded-md [&_code]:inline-block [&_code]:border [&_code]:border-border-muted [&_code]:color-text-highlighted [&_code]:bg-background-muted',
      // Lists
      '[&_:is(ul,ol)]:ps-6',
      '[&_ul]:list-disc [&_ul]:marker:text-(--ui-border-border-accented)',
