  ...
  slots: defu(
    {
      ...
      content: 'max-h-[min(15rem,var(--akar-select-content-available-height))] w-$akar-select-trigger-width bg-background shadow-lg bg-background rounded-md ring ring-ring overflow-hidden origin-$akar-select-content-transform-origin pointer-events-auto flex flex-col',
