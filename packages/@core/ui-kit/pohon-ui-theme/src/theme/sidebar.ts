...
import type { PThemeSidebar } from 'pohon-ui';
...
export const sidebar = {
  slots: {
    ...
    rail: 'absolute inset-y-0 z-20 hidden w-4 transition-all ease-linear after:absolute after:inset-y-0 after:left-1/2 after:w-px lg:flex hover:after:bg-border-accented after:transition-colors',
  },
  variants: {
    side: {
      left: {
