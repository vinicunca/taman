...
<template>
  <div
    class="bg-overlay-content dark:bg-overlay absolute top-0 left-0 z-100 flex size-full flex-col items-center justify-center transition-all duration-500"
    :class="[
      {
  ...
  >
    ...
    <div
      v-if="text"
      class="text-primary mt-4 text-xs"
    >
      {{ text }}
    </div>
    <slot />
