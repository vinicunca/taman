...
export interface InitStoreOptions {
  /**
   * Application name. Since @taman/stores is shared and multiple apps may use it,
   * configure the app name here to avoid cache key collisions. The name is used
   * as the prefix for persisted storage.
   */
  namespace: string;
}
