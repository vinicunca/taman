# Graph Report - taman  (2026-09-21)

## Corpus Check
- 1452 files · ~292,675 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7690 nodes · 11655 edges · 547 communities (372 shown, 151 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 196 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `45b98048`
...
1. `cn()` - 144 edges
2. `POHON_THEME_BRANDS` - 55 edges
3. `FormApi` - 38 edges
4. `scripts` - 33 edges
5. `preferences` - 33 edges
6. `useTamanDialog()` - 33 edges
7. `PreferenceManager` - 32 edges
8. `useTamanDrawer()` - 31 edges
9. `useTamanForm()` - 30 edges
10. `compilerOptions` - 28 edges
...
## Communities (547 total, 151 thin omitted)
...
Cohesion: 0.06
Nodes (30): initApplication(), overridesPreferences, PlaygroundPreferencesExtension, preferencesExtension, DemoTaskItem, demoTasks, formattedPlaygroundPreferences, HighlightTone (+22 more)
...
Cohesion: 0.05
Nodes (22): getBigIntData(), routes, tabs, tabsValue, userStore, formSchema, formSchema, formSchema (+14 more)

### Community 5 - "shadcn-ui/src/ui/index.ts"
Cohesion: 0.04
Nodes (52): CustomRenderType, isDisabled, Props, ValueType, VbenButtonGroupProps, VbenButtonProps, btnDefaultProps, emit (+44 more)
...
### Community 8 - "packages/icons/src/index.ts"
Cohesion: 0.09
Nodes (27): chartTabs, overviewItems, iconValue1, iconValue2, iconValue3, iconValue4, inputComponent, createIconifyIcon() (+19 more)

### Community 9 - "locales/index.ts"
Cohesion: 0.09
Nodes (17): loadDayjsLocale(), loadMessages(), loadThirdPartyMessage(), localesMap, modules, setupI18n(), AllFieldsDateRange, AllFieldsEncodedDateRange (+9 more)

### Community 10 - "form.types.ts"
Cohesion: 0.06
Nodes (45): deleteValueByFieldName(), getValueByFieldName(), resolveFieldNamePath(), setValueByFieldName(), [
  injectRenderFormProps,
  provideFormRenderProps,
], useFormContext(), createDependencyState(), DependencyState (+37 more)
...
### Community 12 - "auth-login.vue"
Cohesion: 0.08
Nodes (18): formSchema, sessionStore, formSchema, FormBaseComponentType, emits, [FormAuth, formAuthApi], props, providers (+10 more)

### Community 13 - "echarts/index.ts"
Cohesion: 0.11
...
### Community 18 - "taman-menu-item.vue"
Cohesion: 0.11
Nodes (18): isHttpUrl(), active, collapseShowTitle, emit, handleClick(), isHttp, isTopLevelMenuItem, item (+10 more)
...
### Community 20 - "form-types.test.ts"
Cohesion: 0.07
...
### Community 23 - "use-vxe-grid.vue"
Cohesion: 0.10
Nodes (23): mergeWithArrayOverride, extendProxyOption(), extendProxyOptions(), delegatedFormSlots, delegatedSlots, events, [Form, formApi], {
  gridOptions,
  class: className,
  gridClass,
  gridEvents,
...
### Community 32 - "VxeGridApi"
Cohesion: 0.13
Nodes (7): getDefaultState(), VxeGridApi, ExtendedVxeGridApi, VxeGridProps, FilteredSlots, Props, UseVbenVxeGrid
...
### Community 36 - "use-menu-context.ts"
Cohesion: 0.18
Nodes (14): createMenuContext(), createSubMenuContext(), menuContextKey, useSubMenuContext(), useMenu(), useMenuStyle(), TAMAN_MENU_ROOT_NAME, TAMAN_MENU_SUB_MENU_NAME (+6 more)
...
Cohesion: 0.14
Nodes (16): TamanMenuRecordRaw, Props, MenuItemClicked, MenuProps, forward, Props, hasChildren, Props (+8 more)
...
Cohesion: 0.11
Nodes (28): createMenu(), deleteMenu(), getMenuList(), isMenuNameExists(), isMenuPathExists(), SystemMenu, SystemMenuApi, updateMenu() (+20 more)

### Community 45 - "ui/select/index.ts"
Cohesion: 0.05
Nodes (25): emits, forwarded, props, delegatedProps, emits, forwarded, props, props (+17 more)

### Community 46 - "form-actions.vue"
Cohesion: 0.15
...
Cohesion: 0.22
Nodes (7): getLayoutScrollElement(), createRouterMock(), mountLayoutScroll(), getHashTarget(), getHistoryPosition(), LayoutScrollRouter, useLayoutScroll()

### Community 49 - "dialog/typed-data-auto-demo.vue"
Cohesion: 0.50
...
Cohesion: 0.10
Nodes (17): { accessMode, hasAccessByCodes }, accounts, changeAccount(), router, sessionStore, userStore, { accessMode, toggleAccessMode }, accounts (+9 more)

### Community 54 - "dept/list.vue"
Cohesion: 0.13
Nodes (21): createDept(), deleteDept(), getDeptList(), SystemDept, SystemDeptApi, updateDept(), useColumns(), useSchema() (+13 more)
...
### Community 59 - "taman-ui/src/index.ts"
Cohesion: 0.08
Nodes (30): AlertBeforeCloseScope, AlertContext, AlertPromptProps, AlertProps, alertIds, clearAllAlerts(), { $t }, doCancel() (+22 more)
...
Cohesion: 0.04
Nodes (53): ComponentsState, GlobalShareState, IGlobalSharedState, MessageState, COMPONENT_MAP, rehydrateFormComponentMaps(), replaceRecord(), setupTamanForm() (+45 more)

### Community 67 - "ui/tree/tree.vue"
Cohesion: 0.11
Nodes (19): checkAll(), emits, expanded, expandNodes(), flattenData, getItemByValue(), InnerFlattenItem, isNodeDisabled() (+11 more)
...
Cohesion: 0.06
Nodes (24): [AutoHeightDialog, autoHeightDialogApi], [BaseDialog, baseDialogApi], [BlurDialog, blurDialogApi], [DragDialog, dragDialogApi], [DynamicDialog, dynamicDialogApi], [FormDialog, formDialogApi], [InContentDialog, inContentDialogApi], [NestedDialog, nestedDialogApi] (+16 more)
...
Cohesion: 0.07
Nodes (24): attrs, close(), currentList, currentSelect, emit, getBindAttrs, handleClick(), innerIcons (+16 more)
...
Cohesion: 0.09
Nodes (26): AsyncFieldValidator, AsyncStandardSchemaValidator, asyncValidatorKeys, createRuntimeFieldComponent(), wrapValidators(), FieldValidationInvalidator, isAsyncStandardSchemaValidator(), normalizeError() (+18 more)
...
Cohesion: 0.10
Nodes (7): isMacOs(), isNumber(), PreferenceManager, CustomPreferencesField, CustomPreferencesRecord, Preferences, PreferencesExtension

### Community 86 - "drawer.vue"
Cohesion: 0.11
Nodes (12): {
  appendToMain,
  cancelText,
...
### Community 102 - "Plan 001: Mount imperative alerts through Pohon's in-app overlay host"
Cohesion: 0.11
Nodes (17): Commands you will need, Current state, Done criteria, Git workflow, Maintenance notes, Plan 001: Mount imperative alerts through Pohon's in-app overlay host, Scope, Status (+9 more)
...
Cohesion: 0.15
Nodes (15): ELEMENT_ID_LAYOUT_SCROLL, elementNeedsScrollbar(), getElementVisibleRect(), getScrollbarWidth(), needsScrollbar(), triggerWindowResize(), VisibleDomRect, mountScrollLock() (+7 more)

### Community 110 - "builtin.vue"
Cohesion: 0.10
Nodes (21): convertToHsl(), generatorColorVariables(), createTimeCodec(), decodeTimeValues(), encodeTimeValues(), isTimeValue(), parseIsoTime(), transformTimeValue() (+13 more)
...
Cohesion: 0.08
Nodes (24): dependencies, pohon-ui, @taman-core/form-ui, @taman-core/popup-ui, @taman-core/shared, @taman-core/taman-ui, @taman/locales, @taman/types (+16 more)

### Community 116 - "backend-mock/project.json"
Cohesion: 0.10
Nodes (21): cache, command, options, cache, command, options, NODE_OPTIONS, name (+13 more)

### Community 117 - "copyright.vue"
Cohesion: 0.17
...
### Community 120 - "effects/composables/src/index.ts"
Cohesion: 0.08
Nodes (19): buttonProps, modelValue, props, {
  closeAllTabs,
  closeCurrentTab,
  closeLeftTabs,
  closeOtherTabs,
  ...
  resetTabTitle,
  setTabTitle,
}, newTabTitle, router, createWaterMark(), { destroyWatermark, updateWatermark, watermark } (+11 more)
...
### Community 123 - "useSimpleLocale"
Cohesion: 0.27
Nodes (6): useSimpleLocale, getMessages(), Locale, messages, collapsed, { $t }

### Community 124 - "use-viewed-row.ts"
Cohesion: 0.17
Nodes (20): isBoolean(), applyViewedRowOptions(), createIndexedDBAdapter(), createStorageAdapter(), createWebStorageAdapter(), enforceMaxSize(), mergeClassNames(), normalizeClassName() (+12 more)

### Community 125 - "query-client.ts"
Cohesion: 0.19
Nodes (7): FetchErrorLike, getErrors(), HTTP_STATUS_MESSAGE_KEYS, TODO: move these status numbers into the locale's JSON instead., notifyQueryError(), queryClient, useTamanToast()
...
Cohesion: 0.08
Nodes (30): TamanTabDefinition, useBreakpoints(), useSortable(), active, active, emits, onMouseDown(), Props (+22 more)

### Community 130 - "RadioGroup.vue"
Cohesion: 0.20
Nodes (7): delegatedProps, emits, forwarded, props, delegatedProps, forwardedProps, props

### Community 131 - "request.ts"
Cohesion: 0.10
Nodes (15): getMockStatusApi(), DemoTableApi, PageFetchParams, UploadFileParams, { apiUrl }, baseRequestClient, createRequestClient(), doReAuthenticate() (+7 more)

### Community 132 - "vxe-table/types.ts"
Cohesion: 0.10
Nodes (22): injectPluginsOptions(), VbenPluginsComponentsOptions, VbenPluginsFormOptions, VbenPluginsMessageOptions, VbenPluginsModalOptions, VbenPluginsOptions, extendsDefaultFormatter(), createVirtualComponent() (+14 more)
...
Cohesion: 0.03
Nodes (50): TamanFormProps, TamanFormSchema, useTamanForm(), { dataUpdatedAt, promise: fetchDataFn }, [Form], queryKey, schema, blur (+42 more)
...
### Community 151 - "dev/vben.ts"
Cohesion: 0.14
Nodes (16): routes, VBEN_ANT_PREVIEW_URL, VBEN_ANTDV_NEXT_PREVIEW_URL, VBEN_DOC_URL, VBEN_ELE_PREVIEW_URL, VBEN_GITHUB_URL, VBEN_LOGO_URL, VBEN_NAIVE_PREVIEW_URL (+8 more)
...
### Community 153 - "preferences-sidebar.vue"
Cohesion: 0.08
...
### Community 154 - "types/src/index.ts"
Cohesion: 0.09
Nodes (21): getUserInfoApi(), formSchema, MOCK_ROLES_OPTIONS, profileBaseSettingRef, emit, [Form, formApi], handleSubmit(), Props (+13 more)
...
### Community 159 - "use-taman-drawer.ts"
Cohesion: 0.10
Nodes (18): CloseIconPlacement, DrawerComponentInstance, DrawerPlacement, ExtendedDrawerApi, InferDrawerData, DrawerData, TypedDrawerData, [, drawerApi] (+10 more)

### Community 160 - "taman-file-upload.vue"
Cohesion: 0.24
Nodes (5): FileUploadSlotFiles, modelValue, props, rootProps, TamanFileUploadProps

### Community 161 - "preferences"
Cohesion: 0.17
...
### Community 162 - "file-download/index.vue"
Cohesion: 0.20
...
### Community 165 - "custom/custom.vue"
Cohesion: 0.36
...
### Community 166 - "tamanConfirm"
Cohesion: 0.22
Nodes (7): openConfirm(), tamanConfirm(), ForeignOverlay, dropdownItems, emits, handleLogout(), Props
...
### Community 177 - "spinner/spinner.vue"
Cohesion: 0.17
Nodes (7): Props, renderSpinner, showSpinner, Props, renderSpinner, showSpinner, timer

### Community 178 - "utils/index.ts"
Cohesion: 0.04
Nodes (36): loadScript(), uniqueByField(), props, props, props, props, props, props (+28 more)
...
Cohesion: 0.20
Nodes (13): i18n, loadLocalesMap(), loadLocalesMapFromDir(), localesMap, modules, { setSimpleLocale }, ImportLocaleFn, LoadMessageFn (+5 more)

### Community 198 - "bootstrap.ts"
Cohesion: 0.20
Nodes (9): ComponentType, initComponentAdapter(), LegacyComponentType, withDefaultPlaceholder(), initTamanForm(), bootstrap(), setQueryClientAppContext(), registerLoadingDirective() (+1 more)

### Community 199 - "header-scroll-state.ts"
Cohesion: 0.25
...
### Community 205 - "general.vue"
Cohesion: 0.14
Nodes (13): getTimezoneOptions(), [DialogTimezone, dialogTimezoneApi], props, timezoneOptions, timezoneRef, appDynamicTitle, appEnableCheckUpdates, appEnableCopyPreferences (+5 more)
...
### Community 208 - "components/widgets/index.ts"
Cohesion: 0.25
...
### Community 210 - "taman-back-to-top.vue"
Cohesion: 0.20
...
### Community 220 - "format-calendar-input-value.ts"
Cohesion: 0.29
...
### Community 225 - "point-selection-captcha-card.vue"
Cohesion: 0.43
Nodes (6): captchaStyles, emit, handleClick(), parseValue(), props, rootStyles

### Community 226 - "RequestClient"
Cohesion: 0.08
Nodes (21): isUndefined(), DownloadRequestConfig, FileDownloader, defaultRequestInterceptorConfig, defaultResponseInterceptorConfig, InterceptorManager, safeJoinUrl(), SSE (+13 more)

### Community 227 - "widget.vue"
Cohesion: 0.10
...
### Community 230 - "use-layout-viewport-height.test.ts"
Cohesion: 0.26
...
Cohesion: 0.12
Nodes (15): GlobalComponents, vue, ./../../node_modules/.pnpm/pohon-ui@2.0.0-rc7.6_94729d8e300bd9608d7a36eb938da2cc/node_modules/pohon-ui/dist/runtime/components/Card.vue, ./../../node_modules/.pnpm/pohon-ui@2.0.0-rc7.7_53fc48d05091592f8da2bfc9d5e8698a/node_modules/pohon-ui/dist/runtime/components/FileUpload.vue, ./../../node_modules/.pnpm/pohon-ui@2.0.0-rc7.7_53fc48d05091592f8da2bfc9d5e8698a/node_modules/pohon-ui/dist/runtime/components/Form.vue, ./../../node_modules/.pnpm/pohon-ui@2.0.0-rc7.7_53fc48d05091592f8da2bfc9d5e8698a/node_modules/pohon-ui/dist/runtime/components/FormField.vue, ./../../node_modules/.pnpm/pohon-ui@2.0.0-rc7.7_53fc48d05091592f8da2bfc9d5e8698a/node_modules/pohon-ui/dist/runtime/components/Separator.vue, ./../../node_modules/.pnpm/pohon-ui@2.0.0-rc7.7_66510a03e957d19d13fda38348a074e8/node_modules/pohon-ui/dist/runtime/components/Badge.vue (+7 more)
...
### Community 235 - "alert-dialog-content.vue"
Cohesion: 0.19
...
### Community 240 - "form-field-array.vue"
Cohesion: 0.08
Nodes (26): addRow(), arrayLength, arrayPath, buildDefaultRow(), canAdd, canRemove, formRenderProps, gridStyle (+18 more)

### Community 241 - "layout-ui/src/components/index.ts"
Cohesion: 0.18
Nodes (7): overlayViewportStyle, Props, style, Props, style, Props, style

### Community 242 - "captcha/types.ts"
Cohesion: 0.24
...
### Community 243 - "dropdown-menu.vue"
Cohesion: 0.31
...
### Community 248 - "calendar-date-codec.ts"
Cohesion: 0.38
...
### Community 249 - "constants/index.ts"
Cohesion: 0.14
...
### Community 250 - "tiptap/types.ts"
Cohesion: 0.17
Nodes (11): contentMinHeight, previewClass, props, Commands, @tiptap/core, TipTapPreviewProps, TipTapProps, ToolbarAction (+3 more)
...
### Community 258 - "use-auth.query.ts"
Cohesion: 0.22
Nodes (8): AUTH_QUERY_KEY, AuthClientResult, AuthError, unwrapAuthResult(), authQueryKeys, useListUsersQuery(), columnDefs, { data: dataUsers }
...
### Community 263 - "layout-sidebar-mobile-hover.test.ts"
Cohesion: 0.22
...
### Community 268 - "shadcn-ui/src/components/index.ts"
Cohesion: 0.04
Nodes (28): imageStyle, Props, rootStyle, text, backTopStyle, { handleClick, visible }, Props, BacktopProps (+20 more)
...
### Community 274 - "app-fetch-component.types.ts"
Cohesion: 0.18
Nodes (8): ComponentPropsMap, ApiComponentLabelFn, AppFetchComponentOptionsItem, AppFetchComponentProps, AppFetchComponentSharedProps, KebabModelInput, ModelValueInput, ValueInput
...
### Community 288 - "form-integration.test.ts"
Cohesion: 0.11
...
### Community 292 - "session.store.ts"
Cohesion: 0.30
Nodes (8): { apiUrl }, AppSession, AppSessionUser, authClient, clearAuthCache(), refreshSession(), SESSION_QUERY_KEY, sessionQueryOptions
...
Cohesion: 0.08
Nodes (26): DEFAULT_FORM_COMMON_CONFIG, getFormComponentMap(), getCustomDefaultValue(), normalizeSchemaForDefaults(), schemaForZodDefaults(), ExtendedFormApi, TamanFormProps, TamanFormSlots (+18 more)

### Community 316 - "loading/directive.ts"
Cohesion: 0.29
Nodes (5): LOADING_INSTANCE_KEY, loadingDirective, loadingDirectiveParams, SPINNER_INSTANCE_KEY, spinningDirective

### Community 317 - "mapTree"
Cohesion: 0.38
...
### Community 318 - "layout-core-menu-mixed.vue"
Cohesion: 0.25
Nodes (6): emit, NormalMenuProps, Props, emits, Props, route
...
### Community 321 - "button-group/index.vue"
Cohesion: 0.22
Nodes (5): checkValue, compProps, [Form], options, radioValue

### Community 322 - "AvatarFallback.vue"
Cohesion: 0.25
Nodes (4): props, delegatedProps, props, props

### Community 324 - "ScrollArea.vue"
Cohesion: 0.33
...
### Community 329 - "helpers/index.ts"
Cohesion: 0.38
...
### Community 340 - "taman-core-layout-header.vue"
Cohesion: 0.40
...
### Community 345 - "tiptap/index.vue"
Cohesion: 0.33
Nodes (5): content, enableUpload, imageUpload, previewContent, ImageUploadOptions

### Community 346 - "request-params-serializer/index.vue"
Cohesion: 0.33
...
### Community 357 - "generate-routes-frontend.ts"
Cohesion: 0.60
Nodes (4): generateRoutesByFrontend(), hasAuthority(), menuHasVisibleWithForbidden(), mockRoutes

### Community 359 - "Implementation Plans"
Cohesion: 0.33
Nodes (5): Dependency notes, Execution order & status, Findings considered and rejected, Implementation Plans, Verification exception
...
Cohesion: 0.11
Nodes (11): [Drawer, drawerApi], { toaster }, [Drawer, drawerApi], { toaster }, AutoDrawerData, data, [Drawer, drawerApi], ELEMENT_ID_MAIN_CONTENT (+3 more)

### Community 379 - "taman-logo.vue"
Cohesion: 0.29
Nodes (5): fullLogoStyle, logoSrc, props, shouldShowText, shouldUseFullLogo

### Community 392 - "drawer/shared-data-demo.vue"
Cohesion: 0.40
Nodes (4): data, [Drawer, drawerApi], SharedData, { toaster }

### Community 395 - "setup.ts"
Cohesion: 0.40
...
### Community 418 - "slider-captcha-content.vue"
Cohesion: 0.50
Nodes (3): contentRef, props, style

### Community 430 - "Badge.vue"
Cohesion: 0.40
...
### Community 559 - "app-page.vue"
Cohesion: 0.33
Nodes (4): contentStyle, props, slots, AppPageProps

## Knowledge Gaps
- **3452 isolated node(s):** `name`, `version`, `private`, `license`, `build` (+3447 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 4072 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **151 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `useTamanDialog()` connect `useTamanDialog` to `dialog/index.vue`, `form.ts`, `general.vue`, `useTamanToast`, `tiptap.vue`, `layout-core-header.vue`, `dialog/typed-data-auto-demo.vue`, `dept/list.vue`, `popup-ui/src/index.ts`, `drag-demo.vue`, `login-expired-modal.vue`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `RadioGroup.vue`, `shadcn-ui/src/ui/index.ts`, `shadcn-ui/src/components/index.ts`, `SheetContent.vue`, `ui/context-menu/index.ts`, `ui/dropdown-menu/index.ts`, `PinInput.vue`, `checkbox.vue`, `descriptions.vue`, `use-vxe-grid.vue`, `table-action.vue`, `ResizableHandle.vue`, `DialogContent.vue`, `slider-captcha/index.vue`, `ui/select/index.ts`, `Badge.vue`, `spinner/spinner.vue`, `utils/index.ts`, `shadcn-ui/src/components/scrollbar/scrollbar.vue`, `segmented.vue`, `PopoverContent.vue`, `AvatarFallback.vue`, `TooltipContent.vue`, `ScrollArea.vue`, `ui/tree/tree.vue`, `input-password.vue`, `tiptap.vue`, `page.vue`, `AccordionItem.vue`, `HoverCardContent.vue`, `AlertDialogContent.vue`, `FormLabel.vue`, `useTiptapToolbar`, `tiptap/types.ts`, `ToggleGroup.vue`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `useTamanDrawer()` connect `useTamanDrawer` to `packages/preferences/src/index.ts`, `drawer/shared-data-demo.vue`, `locales/index.ts`, `form.ts`, `menu/modules/form.vue`, `drawer/auto-height-demo.vue`, `DrawerApi`, `user/modules/form.vue`, `drawer/index.vue`, `layout-widget-preferences-drawer.vue`, `role/list.vue`, `use-taman-drawer.ts`?**
