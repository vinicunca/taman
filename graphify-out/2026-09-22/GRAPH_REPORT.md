# Graph Report - taman  (2026-09-22)

## Corpus Check
- 1452 files · ~293,170 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7691 nodes · 11657 edges · 560 communities (383 shown, 153 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 196 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e90fa635`
...
## Communities (560 total, 153 thin omitted)
...
### Community 7 - "effects/composables/src/index.ts"
Cohesion: 0.05
Nodes (18): buttonProps, modelValue, props, HoverDelayOptions, useHoverToggle(), clearTimers(), setValueDelay(), useTabs() (+10 more)
...
Cohesion: 0.06
Nodes (43): deleteValueByFieldName(), getValueByFieldName(), resolveFieldNamePath(), setValueByFieldName(), [
  injectRenderFormProps,
  provideFormRenderProps,
], useFormContext(), createDependencyState(), DependencyState (+35 more)

### Community 11 - "taman-core-layout.vue"
Cohesion: 0.04
Nodes (49): useLayout(), activeSidebarCollapse, {
  arrivedState,
  directions,
  y: scrollY,
...
Cohesion: 0.15
Nodes (20): CustomNode, Node, TreeNode, filterTree(), mapTree(), sortTree(), TreeConfigOptions, generateAccessible() (+12 more)

### Community 18 - "taman-menu-item.vue"
Cohesion: 0.10
Nodes (19): isHttpUrl(), active, collapseShowTitle, emit, handleClick(), isHttp, isTopLevelMenuItem, item (+11 more)
...
Cohesion: 0.04
Nodes (55): toFormFieldValue(), open, Props, Props, collapseOpen, compact, { componentMap }, componentRefMap (+47 more)
...
Cohesion: 0.18
Nodes (12): openRouteInNewWindow(), openWindow(), OpenWindowOptions, useMenuExtra(), calcExtraMenus(), useMenuMixed(), calcSideMenus(), useNavigation() (+4 more)
...
Cohesion: 0.13
Nodes (8): isBoolean(), getDefaultState(), VxeGridApi, VxeGridProps, ViewedRowHelper, FilteredSlots, separatorBg, UseVbenVxeGrid
...
### Community 36 - "check-button-group.vue"
Cohesion: 0.10
...
### Community 42 - "form-component-performance.benchmark.ts"
Cohesion: 0.08
...
### Community 49 - "api/index.ts"
Cohesion: 0.13
Nodes (7): getUserInfoApi(), getMockStatusApi(), formSchema, MOCK_ROLES_OPTIONS, profileBaseSettingRef, handleClick(), UserInfo
...
### Community 52 - "preferences-sidebar.vue"
Cohesion: 0.05
...
Cohesion: 0.07
Nodes (28): { accessMode, hasAccessByCodes }, accounts, changeAccount(), router, sessionStore, userStore, { accessMode, toggleAccessMode }, accounts (+20 more)
...
Cohesion: 0.07
Nodes (30): activePath, calcMenuItemWidth(), calcSliceIndex(), close(), closeMenu(), debounce(), emit, enableScroll (+22 more)
...
Cohesion: 0.05
Nodes (35): ComponentsState, GlobalShareState, IGlobalSharedState, MessageState, COMPONENT_MAP, rehydrateFormComponentMaps(), replaceRecord(), setupTamanForm() (+27 more)
...
Cohesion: 0.05
Nodes (26): [AutoHeightDialog, autoHeightDialogApi], [BaseDialog, baseDialogApi], [BlurDialog, blurDialogApi], [DragDialog, dragDialogApi], [DynamicDialog, dynamicDialogApi], [FormDialog, formDialogApi], [InContentDialog, inContentDialogApi], [NestedDialog, nestedDialogApi] (+18 more)
...
Cohesion: 0.07
Nodes (34): active, contentProps, currentLevel, isFirstLevel, isTopLevelMenuSubmenu, item, items, menuIcon (+26 more)
...
Cohesion: 0.03
Nodes (54): isWindowsOs(), transitionEnable, transitionLoading, transitionName, transitionPreset, transitionProgress, breadcrumbEnable, breadcrumbHideOnlyOne (+46 more)
...
Cohesion: 0.10
Nodes (19): emit, [Form, formApi], handleSubmit(), Props, router, calcZIndex(), getZIndex, isZIndexExcludeClass() (+11 more)
...
### Community 117 - "base/icons/src/index.ts"
Cohesion: 0.13
...
### Community 125 - "bootstrap.ts"
Cohesion: 0.06
Nodes (36): FetchErrorLike, getErrors(), HTTP_STATUS_MESSAGE_KEYS, TODO: move these status numbers into the locale's JSON instead., { apiUrl }, AppSession, AppSessionUser, authClient (+28 more)
...
### Community 128 - "Tabs.vue"
Cohesion: 0.12
Nodes (11): delegatedProps, emits, forwarded, props, delegatedProps, props, delegatedProps, props (+3 more)

### Community 129 - "taman-tabs-view.vue"
Cohesion: 0.26
Nodes (8): StrictContextMenuItem, StrictContextMenuItemBase, TabsProps, emit, forward, {
  handleScrollAt,
  handleWheel,
...
Cohesion: 0.19
Nodes (9): { apiUrl }, baseRequestClient, createRequestClient(), doReAuthenticate(), PageFetchParams, authenticateResponseInterceptor(), defaultResponseInterceptor(), errorMessageResponseInterceptor() (+1 more)

### Community 132 - "vxe-table/types.ts"
Cohesion: 0.15
Nodes (17): injectPluginsOptions(), extendsDefaultFormatter(), createVirtualComponent(), initVxeTable(), normalizeVxeLocale(), setupVbenVxeTable(), useTableForm(), SeparatorOptions (+9 more)
...
Cohesion: 0.05
Nodes (32): ComponentType, initComponentAdapter(), LegacyComponentType, withDefaultPlaceholder(), initTamanForm(), TamanFormProps, TamanFormSchema, useTamanForm() (+24 more)
...
### Community 153 - "requestClient"
Cohesion: 0.16
Nodes (7): getBigIntData(), DemoTableApi, PageFetchParams, UploadFileParams, requestClient, fetchData(), response
...
### Community 159 - "useTamanDrawer"
Cohesion: 0.08
Nodes (21): [Drawer, drawerApi], list, { toaster }, ExtendedDrawerApi, InferDrawerData, mountPreopenedDrawer(), DrawerData, TypedDrawerData (+13 more)

### Community 160 - "array-fields.vue"
Cohesion: 0.13
...
### Community 161 - "src/update-css-variables.ts"
Cohesion: 0.19
...
Cohesion: 0.14
Nodes (18): AlertBeforeCloseScope, AlertContext, AlertPromptProps, AlertProps, alertIds, clearAllAlerts(), { $t }, tamanAlert() (+10 more)
...
### Community 172 - "cn"
Cohesion: 0.06
Nodes (25): cn(), BORDERED_PADDING, cellClass, displayContent, displayLabel, hasContent, hasLabel, labelClass (+17 more)
...
Cohesion: 0.06
Nodes (20): [DialogAutoHeight, dialogAutoHeightApi], list, { toaster }, [DialogBasic, dialogBasicApi], { toaster }, [DialogInContent, dialogInContentApi], { toaster }, value (+12 more)
...
Cohesion: 0.06
Nodes (21): loadScript(), uniqueByField(), delegatedProps, forwardedProps, props, delegatedProps, emits, forwarded (+13 more)
...
Cohesion: 0.16
Nodes (19): useCaptchaPoints(), addPoint(), clearPoints(), { addPoint, clearPoints, points }, clear(), emit, getElementPosition(), handleClick() (+11 more)

### Community 197 - "locales/src/index.ts"
Cohesion: 0.07
Nodes (34): loadDayjsLocale(), loadMessages(), loadThirdPartyMessage(), localesMap, modules, setupI18n(), preferences, i18n (+26 more)

### Community 198 - "taman-tabs-chrome.vue"
Cohesion: 0.20
Nodes (10): TamanTabDefinition, active, emits, onMouseDown(), Props, style, tabItems, TabConfig (+2 more)
...
### Community 223 - "use-tabs-drag.ts"
Cohesion: 0.24
...
Cohesion: 0.16
Nodes (9): isUndefined(), DownloadRequestConfig, FileDownloader, InterceptorManager, FileUploader, getParamsSerializer(), RequestClient, RequestClientConfig (+1 more)

### Community 227 - "request-client/types.ts"
Cohesion: 0.20
Nodes (8): defaultRequestInterceptorConfig, defaultResponseInterceptorConfig, ExtendOptions, HttpResponse, RequestContentType, RequestInterceptorConfig, RequestResponse, ResponseInterceptorConfig
...
Cohesion: 0.06
Nodes (31): addRow(), arrayLength, arrayPath, buildDefaultRow(), canAdd, canRemove, formRenderProps, gridStyle (+23 more)

### Community 241 - "layout-ui/src/components/index.ts"
Cohesion: 0.18
Nodes (7): overlayViewportStyle, Props, style, Props, style, Props, style

### Community 242 - "profile/index.vue"
Cohesion: 0.18
...
Cohesion: 0.21
Nodes (9): CSS_VARIABLE_LAYOUT_CONTENT_HEIGHT, CSS_VARIABLE_LAYOUT_CONTENT_WIDTH, CSS_VARIABLE_LAYOUT_FOOTER_HEIGHT, CSS_VARIABLE_LAYOUT_HEADER_HEIGHT, ELEMENT_ID_MAIN_CONTENT, setup(), useLayoutContentStyle(), useLayoutFooterStyle() (+1 more)
...
Cohesion: 0.05
Nodes (34): usePreferences(), useContentMaximize(), useRefresh(), transformComponent(), useLayoutComposable(), { getCachedTabs, getExcludeCachedTabs, renderRouteView }, { getEnabledTransition, getTransitionName }, { keepAlive } (+26 more)
...
### Community 274 - "cropper/index.vue"
Cohesion: 0.20
...
### Community 292 - "use-form-field.ts"
Cohesion: 0.27
Nodes (6): {
  error,
  formItemId,
...
Cohesion: 0.09
Nodes (12): routes, routes, routes, ROUTE_ORDER, contextMenus(), needHidden(), text, [Form, formApi] (+4 more)
...
Cohesion: 0.05
Nodes (37): actionWrapperClass, collapsed, hasCollapsibleFields, isFormBusy, isFormDisabled, Props, resetButtonOptions, [rootProps, form] (+29 more)

### Community 316 - "shadcn-ui/src/index.ts"
Cohesion: 0.10
Nodes (12): LOADING_INSTANCE_KEY, loadingDirective, loadingDirectiveParams, SPINNER_INSTANCE_KEY, spinningDirective, Props, defaultValue, Props (+4 more)

### Community 317 - "ui/profile/base-setting.vue"
Cohesion: 0.22
Nodes (8): emit, [Form, formApi], handleSubmit(), Props, emit, [Form, formApi], handleSubmit(), Props

### Community 318 - "plugins-context.ts"
Cohesion: 0.24
...
### Community 322 - "shadcn-ui/src/ui/index.ts"
Cohesion: 0.04
Nodes (27): modelValue, Props, show, slots, props, delegatedProps, props, props (+19 more)
...
Cohesion: 0.24
Nodes (6): resetRoutes(), traverseTreeValues(), getPopupContainer(), mergeRouteModules(), RouteModuleType, resetStaticRoutes()
...
### Community 337 - "alert-overlay.vue"
Cohesion: 0.25
...
### Community 368 - "form/collapsible.vue"
Cohesion: 0.25
...
### Community 410 - "taman-tabs.vue"
Cohesion: 0.29
Nodes (6): active, emits, onMouseDown(), Props, styleTypeClasses, tabItems

### Community 417 - "tabs/index.vue"
Cohesion: 0.29
Nodes (3): {
  closeAllTabs,
  closeCurrentTab,
...
### Community 418 - "collapsible/collapsible.vue"
Cohesion: 0.29
Nodes (5): delegatedProps, emits, forwarded, open, props

### Community 430 - "form-label.vue"
Cohesion: 0.29
...
### Community 432 - "ui/authentication/code-login.vue"
Cohesion: 0.33
...
- **Why does `useTamanDialog()` connect `useTamanDialog` to `dialog/dynamic-demo.vue`, `dialog/index.vue`, `form.ts`, `layout-widget-lock-screen.vue`, `general.vue`, `useTamanToast`, `DialogApi`, `tiptap.vue`, `layout-core-header.vue`, `dept/list.vue`, `popup-ui/src/index.ts`, `drag-demo.vue`, `login-expired-modal.vue`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `Tabs.vue`, `RadioGroup.vue`, `ButtonVariants`, `SheetContent.vue`, `ui/context-menu/index.ts`, `ui/dropdown-menu/index.ts`, `PinInput.vue`, `descriptions.vue`, `use-vxe-grid.vue`, `table-action.vue`, `check-button-group.vue`, `ResizableHandle.vue`, `DialogContent.vue`, `slider-captcha/index.vue`, `ui/select/index.ts`, `spinner/spinner.vue`, `utils/index.ts`, `shadcn-ui/src/components/scrollbar/scrollbar.vue`, `PopoverContent.vue`, `shadcn-ui/src/ui/index.ts`, `TooltipContent.vue`, `ScrollArea.vue`, `ui/tree/tree.vue`, `tiptap.vue`, `common-ui/src/components/index.ts`, `AccordionItem.vue`, `HoverCardContent.vue`, `AlertDialogContent.vue`, `FormLabel.vue`, `useTiptapToolbar`, `tiptap/types.ts`, `ToggleGroup.vue`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `useFormRuntime()` connect `useFormRuntime` to `@core/composables/src/index.ts`?**
