...
## Corpus Check
- 1444 files · ~288,700 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7649 nodes · 11666 edges · 547 communities (374 shown, 149 thin omitted)
...
- _core/profile/base-setting.vue
- DialogContent.vue
...
## Communities (547 total, 149 thin omitted)
...
Cohesion: 0.07
Nodes (34): loadDayjsLocale(), loadMessages(), loadThirdPartyMessage(), localesMap, modules, setupI18n(), i18n, loadLocaleMessages() (+26 more)
...
Cohesion: 0.08
Nodes (31): VbenTableAction, navTo(), projectItems, quickNavItems, router, todoItems, trendItems, userStore (+23 more)

### Community 8 - "icons/index.vue"
Cohesion: 0.14
Nodes (21): chartTabs, overviewItems, iconValue1, iconValue2, iconValue3, iconValue4, inputComponent, SvgAvatar1Icon (+13 more)

### Community 9 - "form.ts"
Cohesion: 0.05
Nodes (30): TamanFormProps, TamanFormSchema, useTamanForm(), accessStore, badgeProps, colors, [Form], menu (+22 more)

### Community 10 - "echarts/index.ts"
Cohesion: 0.11
Nodes (13): chartRef, { renderEcharts }, chartRef, chartRef, { renderEcharts }, { renderEcharts }, chartRef, { renderEcharts } (+5 more)
...
Cohesion: 0.05
Nodes (42): TamanFormFieldArrayProps, BUILT_IN_COMPONENT_MAP, BuiltInFormComponentType, ActionButtonOptions, Breakpoints, ComponentProps, CustomParamsRenderType, FormArraySchema (+34 more)
...
Cohesion: 0.14
Nodes (21): CustomNode, Node, TreeNode, filterTree(), mapTree(), sortTree(), TreeConfigOptions, generateAccessible() (+13 more)
...
Cohesion: 0.04
Nodes (57): isEmptyFormValue(), toFormFieldValue(), open, Props, Props, {
  changeEventFallback,
...
Cohesion: 0.10
Nodes (22): TamanMenuRecordRaw, emit, NormalMenuProps, Props, Props, MenuProps, forward, Props (+14 more)

### Community 28 - "form-render.schema.ts"
Cohesion: 0.08
Nodes (45): resolveChildUpdateFieldName(), [
  injectRenderFormProps,
  provideFormRenderProps,
], useFormContext(), computedSchema, emits, formComponentProps, formFieldSchemas, getGroupWrapperClass() (+37 more)
...
Cohesion: 0.07
Nodes (40): useColumns(), injectPluginsOptions(), extendProxyOption(), extendProxyOptions(), extendsDefaultFormatter(), createVirtualComponent(), initVxeTable(), normalizeVxeLocale() (+32 more)
...
### Community 39 - "routes/index.ts"
Cohesion: 0.11
Nodes (15): resetRoutes(), router, coreRoutes, accessRoutes, componentKeys, devRouteFiles, devRoutes, externalRoutes (+7 more)

### Community 40 - "utils/index.ts"
Cohesion: 0.08
Nodes (25): loadScript(), uniqueByField(), calendarDateCodec, calendarDateTimeCodec, createCalendarDateCodec(), createCalendarDateTimeCodec(), createTimeCodec(), decodeFormValues() (+17 more)
...
### Community 42 - "_core/profile/base-setting.vue"
Cohesion: 0.15
Nodes (5): getUserInfoApi(), formSchema, MOCK_ROLES_OPTIONS, profileBaseSettingRef, UserInfo
...
Cohesion: 0.10
Nodes (30): OnActionClickFn, OnActionClickParams, useVbenVxeGrid(), createMenu(), deleteMenu(), getMenuList(), isMenuNameExists(), isMenuPathExists() (+22 more)
...
### Community 53 - "loading/directive.ts"
Cohesion: 0.13
Nodes (10): LOADING_INSTANCE_KEY, loadingDirective, loadingDirectiveParams, registerLoadingDirective(), SPINNER_INSTANCE_KEY, spinningDirective, LoadingProps, props (+2 more)
...
### Community 58 - "query-client.ts"
Cohesion: 0.15
Nodes (10): FetchErrorLike, getErrors(), HTTP_STATUS_MESSAGE_KEYS, TODO: move these status numbers into the locale's JSON instead., AuthClientResult, AuthError, unwrapAuthResult(), notifyQueryError() (+2 more)
...
Cohesion: 0.05
Nodes (33): ComponentsState, GlobalShareState, IGlobalSharedState, MessageState, BUILT_IN_COMPONENT_BIND_EVENT_MAP, COMPONENT_BIND_EVENT_MAP, COMPONENT_MAP, rehydrateFormComponentMaps() (+25 more)
...
Cohesion: 0.06
Nodes (23): blur, [DialogBlur, dialogBlurApi], [AutoHeightDialog, autoHeightDialogApi], [BaseDialog, baseDialogApi], [BlurDialog, blurDialogApi], [DragDialog, dragDialogApi], [DynamicDialog, dynamicDialogApi], [FormDialog, formDialogApi] (+15 more)
...
### Community 75 - "NumberField.vue"
Cohesion: 0.11
Nodes (12): delegatedProps, emits, forwarded, props, props, delegatedProps, forwarded, props (+4 more)

### Community 76 - "useFormRuntime"
Cohesion: 0.09
Nodes (25): AsyncFieldValidator, asyncValidatorKeys, createRuntimeFieldComponent(), FieldValidationInvalidator, normalizeError(), normalizeFieldMetaError(), useFormRuntime(), clearValidation() (+17 more)
...
Cohesion: 0.09
Nodes (9): [Drawer, drawerApi], list, [Drawer, drawerApi], [, autoHeightDrawerApi], [, baseDrawerApi], [, dynamicDrawerApi], [, formDrawerApi], [, inContentDrawerApi] (+1 more)
...
### Community 109 - "@core/composables/src/index.ts"
Cohesion: 0.09
Nodes (18): ELEMENT_ID_LAYOUT_SCROLL, elementNeedsScrollbar(), getElementVisibleRect(), getScrollbarWidth(), needsScrollbar(), triggerWindowResize(), VisibleDomRect, mountScrollLock() (+10 more)
...
### Community 123 - "form-actions.vue"
Cohesion: 0.10
Nodes (15): useSimpleLocale, getMessages(), Locale, messages, actionWrapperClass, collapsed, hasCollapsibleFields, isFormBusy (+7 more)
...
Cohesion: 0.10
Nodes (28): TamanTabDefinition, useBreakpoints(), active, active, emits, onMouseDown(), Props, style (+20 more)

### Community 130 - "RadioGroup.vue"
Cohesion: 0.20
Nodes (7): delegatedProps, emits, forwarded, props, delegatedProps, forwardedProps, props

### Community 131 - "request-client/types.ts"
Cohesion: 0.20
...
Cohesion: 0.09
Nodes (21): getDeptList(), createUser(), SystemUser, SystemUserApi, updateUser(), useSchema(), [Grid, gridApi], useDescriptionItems() (+13 more)

### Community 150 - "captcha/types.ts"
Cohesion: 0.24
...
Cohesion: 0.11
Nodes (14): DemoTableApi, PageFetchParams, UploadFileParams, { apiUrl }, baseRequestClient, createRequestClient(), doReAuthenticate(), PageFetchParams (+6 more)

### Community 156 - "rbac/src/index.ts"
Cohesion: 0.13
Nodes (17): CoreService, DirectorMember, TamanContext, adminRole, adminRoles, statement, userRole, ORGANIZATION_ROLES (+9 more)
...
Cohesion: 0.15
Nodes (19): openConfirm(), openPrompt(), AlertBeforeCloseScope, AlertContext, AlertPromptProps, AlertProps, alerts, clearAllAlerts() (+11 more)
...
### Community 172 - "cn"
Cohesion: 0.04
Nodes (33): cn(), BORDERED_PADDING, cellClass, displayContent, displayLabel, hasContent, hasLabel, labelClass (+25 more)
...
Cohesion: 0.04
Nodes (31): createIconifyIcon(), imageStyle, Props, rootStyle, text, backTopStyle, { handleClick, visible }, Props (+23 more)
...
Cohesion: 0.07
Nodes (25): initTamanForm(), bootstrap(), initApplication(), overridesPreferences, PlaygroundPreferencesExtension, preferencesExtension, setQueryClientAppContext(), DemoTaskItem (+17 more)
...
Cohesion: 0.17
Nodes (8): isUndefined(), DownloadRequestConfig, FileDownloader, InterceptorManager, FileUploader, getParamsSerializer(), RequestClient, RequestClientConfig

### Community 227 - "types/src/index.ts"
Cohesion: 0.04
Nodes (40): getMockStatusApi(), handleClick(), EchartsThemeType, useEcharts(), breadcrumbEnable, breadcrumbHideOnlyOne, breadcrumbShowHome, breadcrumbShowIcon (+32 more)
...
### Community 235 - "button-group/index.vue"
Cohesion: 0.22
...
Cohesion: 0.13
Nodes (18): routes, VBEN_ANT_PREVIEW_URL, VBEN_ANTDV_NEXT_PREVIEW_URL, VBEN_DOC_URL, VBEN_ELE_PREVIEW_URL, VBEN_GITHUB_URL, VBEN_LOGO_URL, VBEN_NAIVE_PREVIEW_URL (+10 more)
...
### Community 254 - "router/access.ts"
Cohesion: 0.21
...
Cohesion: 0.08
Nodes (27): contentRef, delegatedProps, emits, forwarded, { handleAnimationEvent }, props, contentRef, delegatedProps (+19 more)
...
Cohesion: 0.06
Nodes (18): buttonProps, modelValue, props, useContentMaximize(), HoverDelayOptions, useHoverToggle(), clearTimers(), setValueDelay() (+10 more)

### Community 263 - "components.ts"
Cohesion: 0.38
...
Cohesion: 0.09
Nodes (14): routes, routes, routes, ROUTE_ORDER, contextMenus(), needHidden(), text, [CollapseForm] (+6 more)
...
### Community 316 - "packages/icons/src/index.ts"
Cohesion: 0.18
Nodes (7): leftMaxWidth, leftMinWidth, props, loading, loadingV, spinning, spinningV

### Community 317 - "_core/authentication/code-login.vue"
Cohesion: 0.47
...
### Community 323 - "VxeGridApi"
Cohesion: 0.10
Nodes (9): isBoolean(), StateHandler, getDefaultState(), VxeGridApi, VxeGridProps, ViewedRowHelper, FilteredSlots, separatorBg (+1 more)
...
### Community 329 - "renderTableDefault"
Cohesion: 0.67
...
### Community 333 - "typed-data-auto-demo.vue"
Cohesion: 0.50
...
Cohesion: 0.14
Nodes (12): generatorColorVariables(), applyCssVariables(), defaultPreferences, BUILT_IN_THEME_PRESETS, BuiltinThemePreset, COLOR_PRESETS, preferencesManager, STORAGE_KEYS (+4 more)

### Community 337 - "slider-captcha-content.vue"
Cohesion: 0.50
...
### Community 345 - "taman-ui/src/ui/index.ts"
Cohesion: 0.25
...
Cohesion: 0.10
Nodes (19): Props, CloseIconPlacement, DrawerComponentInstance, DrawerPlacement, DrawerProps, ExtendedDrawerApi, InferDrawerData, DrawerData (+11 more)
...
Cohesion: 0.15
Nodes (7): [Drawer, drawerApi], data, [Drawer, drawerApi], mountPreopenedDrawer(), mountRebindingHarness(), checkProps(), useTamanDrawer()

### Community 399 - "collapsible/collapsible.vue"
Cohesion: 0.29
Nodes (5): delegatedProps, emits, forwarded, open, props

### Community 410 - "input-password.vue"
Cohesion: 0.18
Nodes (9): modelValue, Props, show, slots, checkPasswordStrength(), currentColor, currentStrength, props (+1 more)

### Community 418 - "ui/profile/password-setting.vue"
Cohesion: 0.50
Nodes (4): emit, [Form, formApi], handleSubmit(), Props
...
Cohesion: 0.06
Nodes (29): createStack(), Stack, usePreferences(), useRefresh(), transformComponent(), useLayoutComposable(), { getCachedTabs, getExcludeCachedTabs, renderRouteView }, { getEnabledTransition, getTransitionName } (+21 more)

### Community 449 - "Pagination.vue"
Cohesion: 0.40
Nodes (4): delegatedProps, emits, forwarded, props
...
- **Why does `useTamanDialog()` connect `useTamanDialog` to `login-expired-modal.vue`, `dialog/index.vue`, `form.ts`, `layout-widget-lock-screen.vue`, `typed-data-auto-demo.vue`, `useTamanToast`, `tiptap.vue`, `layout-core-header.vue`, `general.vue`, `DialogApi`, `dept/list.vue`, `layout-widget-check-updates.vue`, `drag-demo.vue`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `RadioGroup.vue`, `shadcn-ui/src/ui/index.ts`, `SheetContent.vue`, `ui/context-menu/index.ts`, `ui/dropdown-menu/index.ts`, `PinInput.vue`, `checkbox.vue`, `descriptions.vue`, `Switch.vue`, `input-password.vue`, `use-vxe-grid.vue`, `table-action.vue`, `ResizableHandle.vue`, `DialogContent.vue`, `slider-captcha/index.vue`, `ui/select/index.ts`, `Badge.vue`, `shadcn-ui/src/components/index.ts`, `AccordionItem.vue`, `loading/directive.ts`, `shadcn-ui/src/components/scrollbar/scrollbar.vue`, `segmented.vue`, `Pagination.vue`, `PopoverContent.vue`, `TooltipContent.vue`, `ui/tree/tree.vue`, `tiptap/types.ts`, `NumberField.vue`, `tiptap.vue`, `common-ui/src/components/index.ts`, `AvatarFallback.vue`, `HoverCardContent.vue`, `AlertDialogContent.vue`, `ScrollArea.vue`, `FormLabel.vue`, `Tabs.vue`, `useTiptapToolbar`, `ToggleGroup.vue`, `spinner/spinner.vue`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `PreferenceManager` connect `PreferenceManager` to `preferences/src/preferences.ts`, `StorageManager`?**
