# Graph Report - taman  (2026-09-15)

## Corpus Check
- 1433 files · ~273,691 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7607 nodes · 11793 edges · 524 communities (358 shown, 142 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 197 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `512d92fd`
...
- ui/profile/password-setting.vue
- tiptap.vue
- rbac/src/index.ts
- db-pg/src/index.ts
- include
...
## Communities (524 total, 142 thin omitted)

### Community 0 - "pohon-ui-theme/src/index.ts"
Cohesion: 0.03
Nodes (57): parseThemeClasses(), accordion, authForm, blogPost, blogPosts, changelogVersion, changelogVersions, chatPalette (+49 more)

### Community 1 - "types/src/index.ts"
Cohesion: 0.08
Nodes (18): getUserInfoApi(), formSchema, MOCK_ROLES_OPTIONS, profileBaseSettingRef, COLOR_PRESETS, breadcrumbs, props, route (+10 more)
...
Cohesion: 0.04
Nodes (35): POHON_THEME_BRANDS, alert, avatar, avatarGroup, banner, breadcrumb, calendar, daySizes (+27 more)

### Community 4 - "common-ui/src/index.ts"
Cohesion: 0.06
Nodes (19): getBigIntData(), routes, tabs, tabsValue, userStore, formSchema, formSchema, formSchema (+11 more)

### Community 5 - "locales/src/index.ts"
Cohesion: 0.07
...
Cohesion: 0.03
Nodes (65): cn(), loadScript(), uniqueByField(), ProjectPreferences, BORDERED_PADDING, cellClass, displayContent, displayLabel (+57 more)

### Community 7 - "packages/preferences/src/index.ts"
Cohesion: 0.13
...
### Community 8 - "shadcn-ui/src/components/index.ts"
Cohesion: 0.03
Nodes (45): imageStyle, Props, rootStyle, text, backTopStyle, { handleClick, visible }, Props, BacktopProps (+37 more)

### Community 9 - "adapter/form.ts"
Cohesion: 0.05
Nodes (29): ComponentPropsMap, ComponentType, LegacyComponentType, TamanFormProps, TamanFormSchema, useTamanForm(), { dataUpdatedAt, promise: fetchDataFn }, [Form] (+21 more)

### Community 10 - "adapter/vxe-table.ts"
Cohesion: 0.06
Nodes (34): ComponentType, OnActionClickFn, renderTableDefault(), renderBtn(), renderConfirm(), useVbenVxeGrid(), DemoTableApi, getExampleTableApi() (+26 more)
...
### Community 12 - "use-vxe-grid.vue"
Cohesion: 0.10
Nodes (22): mergeWithArrayOverride, extendProxyOption(), extendProxyOptions(), delegatedFormSlots, delegatedSlots, events, [Form, formApi], {
  gridOptions,
  class: className,
  gridClass,
  gridEvents,
...
Cohesion: 0.03
Nodes (67): BUILT_IN_COMPONENT_MAP, BuiltInFormComponentType, ActionButtonOptions, Breakpoints, ComponentProps, CustomParamsRenderType, ExtendedFormApi, FormArraySchema (+59 more)
...
Cohesion: 0.13
Nodes (18): OnActionClickParams, createDept(), deleteDept(), SystemDept, SystemDeptApi, updateDept(), [FormModal, formModalApi], onActionClick() (+10 more)

### Community 18 - "form.config.ts"
Cohesion: 0.06
Nodes (29): BUILT_IN_COMPONENT_BIND_EVENT_MAP, COMPONENT_BIND_EVENT_MAP, COMPONENT_MAP, DEFAULT_FORM_COMMON_CONFIG, getFormComponentMap(), rehydrateFormComponentMaps(), replaceRecord(), setupTamanForm() (+21 more)

### Community 19 - "switch-item.vue"
Cohesion: 0.12
...
Cohesion: 0.05
Nodes (44): initTamanForm(), isEmptyFormValue(), toFormFieldValue(), {
  changeEventFallback,
  colon,
...
}, collapseOpen, compact, { componentBindEventMap, componentMap, isVertical }, componentRefMap (+36 more)

### Community 22 - "descriptions.vue"
Cohesion: 0.09
Nodes (35): Props, hasHeader, VbenDescriptionsItem, mergedColumn, mergedItems, props, resolvedItems, Props (+27 more)
...
Cohesion: 0.05
Nodes (36): accessStore, badgeProps, colors, [Form], menu, route, isValidColor(), ExRouteRecordRaw (+28 more)

### Community 28 - "form-render.schema.ts"
Cohesion: 0.09
Nodes (45): deleteValueByFieldName(), getValueByFieldName(), resolveChildUpdateFieldName(), resolveFieldNamePath(), resolveValueFormatFieldName(), setValueByFieldName(), AnyFormFieldSchema, createArrayChildSchema() (+37 more)
...
### Community 32 - "form-render.context.ts"
Cohesion: 0.19
Nodes (16): [
...
Cohesion: 0.06
Nodes (36): isHttpUrl(), isHttp, isComponent, isRemoteIcon, props, emit, itemClass, onClick() (+28 more)

### Community 36 - "form-render-form.vue"
Cohesion: 0.07
Nodes (34): computedSchema, emits, fieldRules, formCollapsed, formComponentProps, formFieldSchemas, getGroupWrapperClass(), getWrapperClass() (+26 more)
...
### Community 40 - "icons/index.vue"
Cohesion: 0.14
Nodes (20): chartTabs, overviewItems, iconValue1, iconValue2, iconValue3, iconValue4, inputComponent, SvgAvatar1Icon (+12 more)

### Community 41 - "auth-login.vue"
Cohesion: 0.11
Nodes (14): formSchema, sessionStore, formSchema, emits, [FormAuth, formAuthApi], props, providers, rememberMe (+6 more)

### Community 42 - "mapTree"
Cohesion: 0.11
Nodes (24): resetRoutes(), CustomNode, Node, TreeNode, filterTree(), mapTree(), sortTree(), traverseTreeValues() (+16 more)
...
Cohesion: 0.11
Nodes (27): createMenu(), deleteMenu(), getMenuList(), isMenuNameExists(), isMenuPathExists(), SystemMenu, SystemMenuApi, updateMenu() (+19 more)
...
Cohesion: 0.09
Nodes (27): ensureSession(), AUTH_LAYOUT_ROUTE_NAMES, AuthAllowDecisionType, AuthDecision, AuthRedirectDecisionType, MatchedRouteRecord, resolveAuthDecision(), resolveAuthMetaFromMatched() (+19 more)
...
### Community 49 - "dialog/index.vue"
Cohesion: 0.09
Nodes (30): dialogAutoHeightApi, dialogBasicApi, dialogBlurApi, dialogDragApi, dialogDynamicApi, dialogFormApi, dialogInContentApi, dialogNestedApi (+22 more)
...
### Community 53 - "form.codec.ts"
Cohesion: 0.12
Nodes (13): calendarDateCodec, decodeFormValues(), encodeFormValues(), FormCodecError, FormCodecPhase, FormCodec, AtomicValue, FilterFormValues (+5 more)

### Community 54 - "menu.types.ts"
Cohesion: 0.19
...
Cohesion: 0.06
Nodes (27): appName, menus, sessionStore, { setMenuList }, { user }, AuthPageLayout(), CoreLayout(), IFrameView() (+19 more)

### Community 58 - "breadcrumb.vue"
Cohesion: 0.10
...
### Community 59 - "input.ts"
Cohesion: 0.09
Nodes (19): badge, button, fieldGroup, fieldGroupVariant, fieldGroupVariantWithRoot, inputDate, inputSlots, input (+11 more)
...
Cohesion: 0.04
Nodes (51): ColorItem, generatorColorVariables(), isMacOs(), isNumber(), applyCssVariables(), defaultPreferences, BUILT_IN_THEME_PRESETS, BuiltinThemePreset (+43 more)

### Community 64 - "request.ts"
Cohesion: 0.07
Nodes (23): getParamsData(), getMockStatusApi(), UploadFileParams, { apiUrl }, baseRequestClient, createRequestClient(), doReAuthenticate(), PageFetchParams (+15 more)
...
Cohesion: 0.14
Nodes (4): isBoolean(), VxeGridApi, separatorBg, UseVbenVxeGrid
...
Cohesion: 0.07
Nodes (16): routes, routes, routes, ROUTE_ORDER, contextMenus(), needHidden(), currentTab, [FirstForm, firstFormApi] (+8 more)
...
Cohesion: 0.08
Nodes (21): attrs, close(), currentList, currentSelect, emit, getBindAttrs, handleClick(), innerIcons (+13 more)

### Community 74 - "styles/package.json"
Cohesion: 0.07
Nodes (29): default, types, default, types, bugs, dependencies, @vben-core/design, default (+21 more)

### Community 75 - "useTamanToast"
Cohesion: 0.07
Nodes (15): [DialogBasic, dialogBasicApi], { toaster }, [DialogDynamic, dialogDynamicApi], state, { toaster }, [FormDemo, formDemoApi], [Modal, modalApi], { toast } (+7 more)

### Community 76 - "useFormRuntime"
Cohesion: 0.12
Nodes (21): AsyncFieldValidator, asyncValidatorKeys, createRuntimeFieldComponent(), FieldValidationInvalidator, normalizeError(), normalizeFieldMetaError(), useFormRuntime(), clearValidation() (+13 more)
...
### Community 82 - "common-ui/src/components/index.ts"
Cohesion: 0.10
Nodes (14): delegatedProps, delegatedSlots, leftPanelRef, props, slots, ColPageProps, {
...
### Community 85 - "calendar-date-codec.ts"
Cohesion: 0.67
Nodes (4): decodeCalendarDateValues(), encodeCalendarDateValues(), parseIsoDateValue(), transformCalendarDateValue()

### Community 86 - "useTamanForm"
Cohesion: 0.06
Nodes (27): useTamanForm(), TestInput, batchValues, BENCHMARK_OPTIONS, [DependencyForm, dependencyFormApi], dependencySchema, dependencyWrapper, [FlatForm, flatFormApi] (+19 more)
...
Cohesion: 0.08
Nodes (11): [Drawer, drawerApi], [Drawer, drawerApi], [Drawer, drawerApi], [Form, formApi], [, autoHeightDrawerApi], [, baseDrawerApi], [, dynamicDrawerApi], [, formDrawerApi] (+3 more)
...
### Community 90 - "form-render.dependencies.ts"
Cohesion: 0.18
Nodes (15): createDependencyState(), DependencyState, isResolveDependencies(), legacyDependencyKeys, mixedDependenciesWarnings, resolveLegacyDependencies(), resolveValueByFieldName(), useDependencies() (+7 more)

### Community 91 - "useViewedRow"
Cohesion: 0.21
Nodes (15): applyViewedRowOptions(), enforceMaxSize(), mergeClassNames(), normalizeClassName(), useViewedRow(), clearViewed(), getRowClassName(), getRowStyle() (+7 more)
...
### Community 100 - "useTamanDialog"
Cohesion: 0.07
Nodes (25): [DialogAutoHeight, dialogAutoHeightApi], list, { toaster }, [Modal, modalApi], blur, [DialogBlur, dialogBlurApi], Props, ExtendedDialogApi (+17 more)

### Community 101 - "dashboard/typing.ts"
Cohesion: 0.17
Nodes (11): Props, AnalysisOverviewItem, WorkbenchProjectItem, WorkbenchQuickNavItem, WorkbenchTodoItem, WorkbenchTrendItem, Props, Props (+3 more)
...
### Community 105 - "layout-core-tabbar.vue"
Cohesion: 0.15
Nodes (10): closeAllTabs(), { contentIsMaximize, toggleMaximize }, {
  createContextMenus,
  currentActive,
  currentTabs,
  handleClick,
  handleClose,
}, menus, { refreshTab, unpinTab }, route, tabbarStore, useLayoutCoreTabbar() (+2 more)
...
Cohesion: 0.09
Nodes (22): dependencies, akar, @internationalized/date, pohon-ui, @taman-core/composables, @taman-core/shared, unocss-variants, @vueuse/core (+14 more)
...
### Community 118 - "vxe-table/types.ts"
Cohesion: 0.15
Nodes (15): useColumns(), getDefaultState(), ExtendedVxeGridApi, SeparatorOptions, ToolbarConfigOptions, ViewedRowOptions, ViewedRowPersistBase, ViewedRowPersistOptions (+7 more)
...
Cohesion: 0.12
Nodes (20): FetchErrorLike, getErrors(), HTTP_STATUS_MESSAGE_KEYS, TODO: move these status numbers into the locale's JSON instead., { apiUrl }, AppSession, AppSessionUser, authClient (+12 more)

### Community 124 - "form-field-array.vue"
Cohesion: 0.15
Nodes (13): addRow(), arrayLength, arrayPath, buildDefaultRow(), canAdd, canRemove, formRenderProps, gridStyle (+5 more)
...
Cohesion: 0.27
Nodes (10): isPasswordStrong(), PASSWORD_STRENGTH_CHECKS, PASSWORD_STRENGTH_MAX, passwordStrengthScore(), color, inputRef, isPasswordVisible, modelValue (+2 more)

### Community 128 - "@core/composables/src/index.ts"
Cohesion: 0.18
Nodes (7): useBreakpoints(), useSortable(), useExpandable(), findParentElement(), useTabsDrag(), init(), initTabsSortable()

### Community 129 - "cropper/index.vue"
Cohesion: 0.20
...
Cohesion: 0.11
Nodes (16): TAMAN_GITHUB_URL, CSS_VARIABLE_LAYOUT_CONTENT_HEIGHT, CSS_VARIABLE_LAYOUT_CONTENT_WIDTH, CSS_VARIABLE_LAYOUT_FOOTER_HEIGHT, CSS_VARIABLE_LAYOUT_HEADER_HEIGHT, DISMISSABLE_DIALOG_ID, DISMISSABLE_DRAWER_ID, ELEMENT_ID_MAIN_CONTENT (+8 more)

### Community 132 - "init.ts"
Cohesion: 0.16
Nodes (12): injectPluginsOptions(), VbenPluginsComponentsOptions, VbenPluginsFormOptions, VbenPluginsMessageOptions, VbenPluginsModalOptions, VbenPluginsOptions, extendsDefaultFormatter(), createVirtualComponent() (+4 more)
...
### Community 138 - "preferences"
Cohesion: 0.05
Nodes (42): initComponentAdapter(), withDefaultPlaceholder(), VbenTableAction, bootstrap(), setQueryClientAppContext(), { accessMode, hasAccessByCodes }, accounts, changeAccount() (+34 more)
...
### Community 140 - "drawer-types.test.ts"
Cohesion: 0.20
Nodes (5): InferDrawerData, DrawerData, TypedDrawerData, [, drawerApi], TypedDrawerData

### Community 141 - "SheetContent.vue"
Cohesion: 0.07
Nodes (22): emits, forwarded, props, SheetVariants, props, contentRef, delegatedProps, emits (+14 more)
...
### Community 144 - "layout-widget-lock-screen.vue"
Cohesion: 0.11
...
### Community 145 - "withPreviewUpload"
Cohesion: 0.16
...
Cohesion: 0.21
Nodes (10): CoreService, DirectorMember, KNOWN_ORGANIZATION_ROLES, resolveContext(), resolveMember(), TamanContext, toOrganizationRole(), H3EventContext (+2 more)

### Community 147 - "useTamanDrawer"
Cohesion: 0.14
Nodes (8): [Drawer, drawerApi], list, data, [Drawer, drawerApi], mountPreopenedDrawer(), mountRebindingHarness(), checkProps(), useTamanDrawer()
...
Cohesion: 0.10
Nodes (20): getDeptList(), createUser(), SystemUser, SystemUserApi, updateUser(), useSchema(), [Grid, gridApi], useDescriptionItems() (+12 more)

### Community 150 - "taman-menu-item.vue"
Cohesion: 0.17
Nodes (12): active, collapseShowTitle, emit, handleClick(), isTopLevelMenuItem, item, menuIcon, { parentMenu, parentPaths } (+4 more)

### Community 151 - "alert.vue"
Cohesion: 0.15
...
### Community 154 - "ui/profile/password-setting.vue"
Cohesion: 0.17
Nodes (12): emit, handleChange(), emit, [Form, formApi], handleSubmit(), Props, tabsValue, emit (+4 more)

### Community 155 - "tiptap.vue"
Cohesion: 0.05
Nodes (47): content, enableUpload, imageUpload, previewContent, createCustomImage(), createDefaultTiptapExtensions(), createUploadProcess(), findPlaceholderPos() (+39 more)
...
Cohesion: 0.12
Nodes (9): DrawerApi, Props, CloseIconPlacement, DrawerApiOptions, DrawerComponentInstance, DrawerProps, DrawerState, ExtendedDrawerApi (+1 more)
...
### Community 162 - "shadcn-ui/src/index.ts"
Cohesion: 0.13
Nodes (9): contentRef, props, style, Props, defaultValue, Props, modelValue, items (+1 more)
...
### Community 172 - "request-client.ts"
Cohesion: 0.13
...
### Community 177 - "taman-menu-sub-menu-content.vue"
Cohesion: 0.14
...
Cohesion: 0.16
Nodes (12): { currentLocale }, DateRange, DateValue, formatter, InputDateModelValue, inputProps, inputRef, isOpen (+4 more)
...
### Community 194 - "captcha/types.ts"
Cohesion: 0.28
...
### Community 197 - "ui/authentication/code-login.vue"
Cohesion: 0.15
...
### Community 199 - "shadcn-ui/src/ui/index.ts"
Cohesion: 0.04
Nodes (31): Props, modelValue, Props, DropdownMenuProps, VbenDropdownMenuItem, props, delegatedProps, props (+23 more)
...
### Community 206 - "packages/icons/src/index.ts"
Cohesion: 0.13
Nodes (9): leftMaxWidth, leftMinWidth, props, loading, loadingV, spinning, spinningV, createIconifyIcon() (+1 more)

### Community 207 - "bindMethods"
Cohesion: 0.19
Nodes (7): Data, TestClass, TestWithGetterSetter, UserProfile, UserSettings, bindMethods(), getNestedValue()

### Community 208 - "checkbox.vue"
Cohesion: 0.15
...
Cohesion: 0.12
Nodes (6): props, slots, emits, props, withTooltip, { isFullscreen, toggle }
...
Cohesion: 0.15
Nodes (13): dependencies, json-bigint, qrcode, @taman/composables, @taman-core/form-builder, @vben/icons, vue-router, json-bigint (+5 more)
...
Cohesion: 0.10
Nodes (23): applyFormat(), currentTimezone, Format, formatDate, formatDateTime(), getCurrentTimezone(), getSystemTimezone(), getTimezoneOptions() (+15 more)

### Community 223 - "tabbar.vue"
Cohesion: 0.12
...
### Community 235 - "slider-captcha.vue"
Cohesion: 0.18
...
### Community 243 - "usePreferences"
Cohesion: 0.20
Nodes (8): usePreferences(), useContentMaximize(), transformComponent(), useLayoutComposable(), { getCachedTabs, getExcludeCachedTabs, renderRouteView }, { getEnabledTransition, getTransitionName }, { keepAlive }, tabbarStore
...
### Community 246 - "use-taman-drawer.ts"
Cohesion: 0.22
Nodes (7): createTamanDrawer(), DEFAULT_DRAWER_PROPS, DrawerDataNotProvided, { globalEscapeShortcutKey }, ResolvedDrawerData, setDefaultDrawerProps(), TAMAN_DRAWER_INJECT_KEY
...
Cohesion: 0.04
Nodes (27): components, CONTENT_PRESET, modelValue, components, LAYOUT_PRESET, modelValue, PresetItem, props (+19 more)

### Community 249 - "form-actions.vue"
Cohesion: 0.20
Nodes (7): triggerWindowResize(), actionWrapperClass, collapsed, resetButtonOptions, [rootProps, form], submitButtonOptions, { $t }

### Community 250 - "dev/vben.ts"
Cohesion: 0.12
Nodes (19): routes, VBEN_ANT_PREVIEW_URL, VBEN_ANTDV_NEXT_PREVIEW_URL, VBEN_DOC_URL, VBEN_ELE_PREVIEW_URL, VBEN_GITHUB_URL, VBEN_LOGO_URL, VBEN_NAIVE_PREVIEW_URL (+11 more)
...
### Community 254 - "taman-ui/src/index.ts"
Cohesion: 0.12
Nodes (10): canRender(), enableTabbar, iframeRoutes, route, routeShow(), showIframe, spinningList, tabbarStore (+2 more)
...
Cohesion: 0.25
Nodes (7): isDateValue(), CalendarDateRange, formatCalendarInputValue(), isDateRange(), inputValue, april, february

### Community 275 - "global.vue"
Cohesion: 0.29
...
Cohesion: 0.10
Nodes (22): navTo(), projectItems, quickNavItems, router, todoItems, trendItems, userStore, openRouteInNewWindow() (+14 more)
...
### Community 297 - "ComponentPropsMap"
Cohesion: 0.40
Nodes (4): ComponentPropsMap, CollapsibleParamsProps, IconPickerProps, TipTapProps

### Community 298 - "common-ui/tsconfig.json"
Cohesion: 0.25
Nodes (7): exclude, extends, include, node_modules, src, @taman/tsconfig/web.json, $schema

### Community 299 - "effects/composables/src/index.ts"
Cohesion: 0.06
Nodes (16): {
  closeAllTabs,
  closeCurrentTab,
  ...
  resetTabTitle,
  setTabTitle,
}, newTabTitle, router, index, route, { setTabTitle }, createWaterMark(), { destroyWatermark, updateWatermark, watermark } (+8 more)
...
### Community 313 - "layout-sidebar-mobile-hover.test.ts"
Cohesion: 0.22
...
### Community 316 - "slider-captcha-action.vue"
Cohesion: 0.33
Nodes (5): actionRef, isDragging, left, props, style

### Community 317 - "drawer/in-content-demo.vue"
Cohesion: 0.50
...
### Community 321 - "point-selection-captcha-card.vue"
Cohesion: 0.43
Nodes (6): captchaStyles, emit, handleClick(), parseValue(), props, rootStyles

### Community 323 - "header-scroll-state.ts"
Cohesion: 0.25
...
### Community 354 - "collapsible/collapsible.vue"
Cohesion: 0.25
Nodes (5): delegatedProps, emits, forwarded, open, props

### Community 355 - "loading/directive.ts"
Cohesion: 0.14
...
### Community 356 - "slider-captcha-bar.vue"
Cohesion: 0.40
Nodes (4): barRef, props, style, width

### Community 357 - "ui/authentication/forget-password.vue"
Cohesion: 0.33
Nodes (5): emit, [Form, formApi], handleSubmit(), Props, router

### Community 358 - "ui/authentication/register.vue"
Cohesion: 0.33
Nodes (5): emit, [Form, formApi], handleSubmit(), Props, router
...
### Community 526 - "taman-core-layout-header.vue"
Cohesion: 0.40
Nodes (4): logoStyle, Props, slots, style

## Knowledge Gaps
- **3331 isolated node(s):** `name`, `version`, `private`, `license`, `build` (+3326 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 3927 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **142 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `cn()` connect `utils/index.ts` to `RadioGroup.vue`, `shadcn-ui/src/components/index.ts`, `use-vxe-grid.vue`, `SheetContent.vue`, `ui/context-menu/index.ts`, `ui/dropdown-menu/index.ts`, `ButtonVariants`, `descriptions.vue`, `tiptap.vue`, `table-action.vue`, `ResizableHandle.vue`, `DialogContent.vue`, `slider-captcha/index.vue`, `ui/select/index.ts`, `AccordionItem.vue`, `shadcn-ui/src/components/scrollbar/scrollbar.vue`, `segmented.vue`, `PopoverContent.vue`, `TooltipContent.vue`, `ui/tree/tree.vue`, `shadcn-ui/src/ui/index.ts`, `input-password.vue`, `checkbox.vue`, `common-ui/src/components/index.ts`, `useTiptapToolbar`, `AlertDialogContent.vue`, `loading/directive.ts`, `FormLabel.vue`, `form-field-array.vue`, `ToggleGroup.vue`, `spinner/spinner.vue`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `AuthRoleNames` connect `vue-router.d.ts` to `mapTree`, `session.store.ts`, `rbac/src/index.ts`, `guard.ts`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `useTamanDialog()` connect `useTamanDialog` to `drag-demo.vue`, `DialogApi`, `login-expired-modal.vue`, `useTamanToast`, `viewed.vue`, `layout-core-header.vue`, `layout-widget-lock-screen.vue`, `dialog/index.vue`, `dept/list.vue`, `layout-widget-check-updates.vue`, `tiptap.vue`, `general.vue`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **What connects `name`, `version`, `private` to the rest of the system?**
  _3331 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `pohon-ui-theme/src/index.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.02669717772692601 - nodes in this community are weakly interconnected._
